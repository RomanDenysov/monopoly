package com.sokima.monopoly.model.configuration.cell;
...
@Getter
@Setter
@ConfigurationProperties(prefix = "monopoly.cell.social-media")
public class SocialMediaCellConfiguration {
